...
if __name__ == "__main__":
    ...
    model = YOLO(r"E:\code\ultralytics\runs\obb\train2\weights\last.pt")

    img = cv2.imread(r"E:\code\data\tmp\to_train\202412101507567661_F.jpg")
    # img = cv2.imread(r"E:\code\data\gen_barcode_data\train_obb_bak\20241206\images\202412041041271920_F.jpg")
    results = model(img)[0]
    names   = results.names
